...
from segen.config import seq_len_limit,output_path
        ...
        for df,value in self.acyclicPaths.paths_df.items():
            ...
            if isinstance(value,dict):
                ...
                for seq_list in value.values():
                    if len(seq_list)>=100:continue # 11/6/2024 # it is better not to add edges when there are already a lot of sequences
                    for seq in seq_list:
