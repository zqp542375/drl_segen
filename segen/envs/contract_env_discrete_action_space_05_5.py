...
# -*- coding: utf-8 -*-
from segen.config import max_svar_value, max_func_value_element
from segen.env_data_preparation.contract_dynamics import ContractDynamics
from segen.env_data_preparation.fwrg_manager import FWRG_manager
from segen.utils import scale_value_continous, random_selection, weighted_choice, sort_lists, goal_rewarding
    ...
    def env_dynamics(self, action):
        ...
        if len(self.func_seq)<=4 and action==1:
           ...
           # uese r+w (concatenation) to present a function
               ...
               self.state[start_idx_1:start_idx_1+(1+self.num_reads+self.num_writes)]= func_vector_1
